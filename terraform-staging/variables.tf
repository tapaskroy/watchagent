...
variable "subdomain" {
  description = "Subdomain for the application (e.g., staging.watchagent)"
  type        = string
  default     = "staging.watchagent"
}

# VPC Configuration — separate CIDRs from prod (10.0.x.x) to allow future VPC peering
variable "vpc_cidr" {
